...
headingLabel = Label(headingFrame1, text="Welcome to KSIT \n Library", bg='YELLOW', fg='RED', font=('Courier',15))
...
btn6 = Button(root,text="View Issued Book Details",bg='black', fg='white', command = issueView)
